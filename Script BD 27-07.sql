...
CREATE TABLE `tbl_bonos_descuentos` (
  ...
  `Bono-Desc` tinyint(1) DEFAULT NULL,
...
CREATE TABLE `tbl_cliente` (
  ...
  `dpiCliente` varchar(45) DEFAULT NULL,
  `pasaporteCliente` varchar(45) DEFAULT NULL,
...
CREATE TABLE `tbl_perfil` (
  ...
  `estadoPerfil` tinyint(1) DEFAULT NULL,
...
-- Dump completed on 2019-07-27 12:28:21
