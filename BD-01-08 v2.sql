...
BEGIN
insert into tbl_empleado(nombreEmpleado,apellidoEmpleado,fechaNacEmpleado,correo,telefono,DPI,Fk_idUsuario,Cuenta_Bancaria,NIT,Sueldo_Base,Direccion,Departamento,Estado) 
VALUES (nombre,apellido,fechanac,corr,tel,dpi,usu,cuentabancaria,nit,sueldobase,dir,dep,estado);
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
BEGIN
UPDATE tbl_empleado 
SET nombreEmpleado=nombre,apellidoEmpleado=apellido,fechaNacEmpleado=fechanac,correo=corr,telefono=tel,DPI=dpi,Fk_idUsuario=usu,Cuenta_Bancaria=cuentabancaria,NIT=nit,Sueldo_Base=sueldobase,Direccion=dir,Departamento=dep
WHERE Pk_idEmpleado=cod;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
